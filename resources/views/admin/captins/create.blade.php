...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.captin.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.captins.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cv') ? 'is-invalid' : '' }}" type="text" name="cv" id="cv" value="{{ old('cv', '') }}">
                @if($errors->has('cv'))
                    <div class="invalid-feedback">
                        {{ $errors->first('cv') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('hours_cost') ? 'is-invalid' : '' }}" type="text" name="hours_cost" id="hours_cost" value="{{ old('hours_cost', '') }}">
